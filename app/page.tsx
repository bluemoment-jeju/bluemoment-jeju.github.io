...
export default function Home() {
  return <main>
    ...
    <section className="moments"><p className="section-index">THE BLUE MOMENT</p><div className="moment-row"><div><img src="/images/moment-cactus-trail.jpg" alt="월령리 선인장 군락을 따라 이어지는 해안 올레길"/><span>01 · CACTUS TRAIL</span><h3>바다와 선인장 사이<br/>월령리 올레길 산책</h3><p>펜션 앞에서 해안을 따라 걷다 보면 검은 현무암과 초록 선인장 군락이 이어집니다. 월령리에서만 만날 수 있는 특별한 산책을 시작해보세요.</p></div><div><img src="/images/moment-sunset.jpg" alt="블루모먼트 통창 너머로 보이는 월령리 노을"/><span>02 · SUNSET VIEW</span><h3>해가 낮아지면<br/>통창 앞이 가장 좋은 자리</h3><p>월령리의 서쪽 하늘이 물드는 시간. 멀리 나갈 필요 없이 소파와 다이닝에서 노을을 끝까지 바라볼 수 있습니다.</p></div><div><img src="/images/moment-seaside-lawn.jpg" alt="정자와 텐트가 있는 블루모먼트 앞 해변 잔디 공간"/><span>03 · SEASIDE REST</span><h3>정자와 잔디 위에서<br/>바다 곁의 느린 휴식</h3><p>작은 해변과 정자, 푸른 잔디가 바로 앞에 있습니다. 텐트 곁에서 가족과 쉬고 놀며 여유로운 제주 바캉스를 완성해보세요.</p></div></div></section>
    ...
    <section className="amenities" id="amenities">
      ...
      <div className="amenity-grid">
        ...
        <article className="amenity-card amenity-detail amenity-bath"><img src="/images/amenity-bath.jpg" alt="매일 손님을 맞이하기 위해 깨끗하게 청소하고 정돈한 블루모먼트 실제 욕실"/><div className="amenity-card-copy"><small>BATH &amp; CARE</small><h3>가장 사적인 공간까지, 세심하게</h3><p>낯선 여행지에서도 욕실만큼은 우리 집처럼 편안해야 하니까요. 위생과 청결을 무엇보다 중요하게 생각하며, 매일 손님을 맞이하기 전 욕실을 꼼꼼히 청소하고 정돈합니다.</p><p className="amenity-photo-note">사진은 손님을 맞이하기 위해 준비한 실제 욕실의 모습입니다.</p></div></article>
        <article className="amenity-card amenity-detail amenity-kit"><img src="/images/amenity-dental.jpg" alt="고급형 칫솔 치약 면봉 세트"/><div className="amenity-card-copy"><small>BATH &amp; CARE</small><h3>인원수에 맞춘 퍼스널 키트</h3><p>고급형 칫솔과 치약, 면봉 세트를 입실 인원에 맞춰 빠짐없이 준비합니다.</p></div></article>
