...
export default function Home() {
  return <main>
    ...
    <section className="bathroom-section" id="bathroom" aria-labelledby="bathroom-heading"><figure className="bathroom-photo"><img src="/images/amenity-bath.jpg" alt="매일 손님을 맞이하기 위해 깨끗하게 청소하고 정돈한 블루모먼트 실제 욕실"/><figcaption>손님을 맞이하기 위해 준비한 실제 욕실의 모습입니다.</figcaption></figure><div className="bathroom-copy"><p className="section-index">BATHROOM · OUR CARE</p><h2 id="bathroom-heading">가장 사적인 공간까지,<br/>세심하게</h2><p className="bathroom-lead">낯선 여행지에서도 욕실만큼은<br/>우리 집처럼 편안해야 하니까요.</p><p>블루모먼트는 위생과 청결을 무엇보다 중요하게 생각합니다. 매일 손님을 맞이하기 전, 욕실을 꼼꼼히 청소하고 정돈합니다.</p><p>가장 개인적인 공간에서만큼은 마음 놓고 편안히 쉬실 수 있도록. 눈에 잘 띄지 않는 곳까지 세심하게 살피며 준비합니다.</p></div></section>
